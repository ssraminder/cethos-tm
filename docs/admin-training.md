...
4. [Translation Memory](#4-translation-memory)
5. [Termbases](#5-termbases)
6. [QA Profiles](#6-qa-profiles)
7. [Languages](#7-languages)
8. [MT Engines](#8-mt-engines)
9. [Users](#9-users)
10. [Integrations](#10-integrations)
11. [API Keys (TMS push)](#11-api-keys-tms-push)
...
![Sign-in page](screenshots/admin/01-sign-in.png)
...
![Admin dashboard](screenshots/admin/02-admin-dashboard.png)
...
![TM list](screenshots/admin/03-tm-list.png)
...
![TM create](screenshots/admin/04-tm-create.png)
...
![TM detail](screenshots/admin/05-tm-detail.png)
...
![Termbase list](screenshots/admin/06-termbase-list.png)
...
![Termbase create](screenshots/admin/07-termbase-create.png)
...
![Termbase detail](screenshots/admin/08-termbase-detail.png)
...
![QA profiles](screenshots/admin/09-qa-profiles.png)
...
![Languages](screenshots/admin/10-languages.png)
...
![MT engines](screenshots/admin/11-mt-engines.png)
...
![Users](screenshots/admin/12-users.png)
...
![Integrations](screenshots/admin/13-integrations.png)
...
![API keys](screenshots/admin/14-api-keys.png)
...
![Audit log](screenshots/admin/15-audit-log.png)
...
![Settings](screenshots/admin/16-settings.png)
